#ifndef DUBIOUS_DOG_R_RENDERER_H
#define DUBIOUS_DOG_R_RENDERER_H
...
typedef struct _sector {
    ...
    plane_lut_t portal_floorx_ylut;
    plane_lut_t portal_ceilx_ylut;
...
#endif //DUBIOUS_DOG_R_RENDERER_H